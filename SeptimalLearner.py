...
df1 = pandas.read_csv(
    "https://raw.githubusercontent.com/Al3an3rson/Sali-Training/main/SeptimalData.csv",
    sep="~",
    engine="python",
    quoting=3,
)
...
while boo == False:
    ...
    while boo1 == False:
        if question == "alphabet":
            ...
            question1 = input('Which level (1-3) or "all"?: ').lower()
            if question1 == "1":
            ...
            if question1 == "6":
                ...
                boo1 = True
            if question1 == "7":
                sequence = [55, 56, 57, 58]
                boo1 = True
            if question1 == "all":
                sequence = [i for i in range(36, 59)]
                boo1 = True
        elif question == "all":
